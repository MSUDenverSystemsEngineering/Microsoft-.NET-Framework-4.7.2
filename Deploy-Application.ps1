...
Try {
	...
	[string]$appVersion = '4.7.2'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '07/31/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "NDP472-KB4054530-x86-x64-AllOS-ENU.exe" -Parameters "/q /norestart" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "NDP472-KB4054530-x86-x64-AllOS-ENU.exe" -Parameters "/uninstall /q /norestart" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) {
			$mainExitCode = $exitCode.ExitCode
		}
